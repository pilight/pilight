...
void lm75Init(void) {
	...
	options_add(&lm75->options, 't', "temperature", OPTION_HAS_VALUE, CONFIG_VALUE, JSON_NUMBER, "^[0-9]{1,3}$");
	options_add(&lm75->options, 'i', "id", OPTION_HAS_VALUE, CONFIG_ID, JSON_STRING, "0x[0-9a-f]{2}");
