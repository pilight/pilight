...
void genDimInit(void) {
	...
	options_add(&generic_dimmer->options, 0, "dimlevel-minimum", OPTION_HAS_VALUE, DEVICES_VALUE, JSON_NUMBER, (void *)0, "^([0-9]{1}|[1][0-5])$");
	options_add(&generic_dimmer->options, 0, "dimlevel-maximum", OPTION_HAS_VALUE, DEVICES_VALUE, JSON_NUMBER, (void *)15, "^([0-9]{1}|[1][0-5])$");
