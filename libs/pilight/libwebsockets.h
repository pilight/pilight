...
#define lwsl_notice(...) logprintf(LLL_NOTICE, __VA_ARGS__)
#define lwsl_warn(...) logprintf(LLL_WARN, __VA_ARGS__)
#define lwsl_err(...) logprintf(LLL_ERR, __VA_ARGS__)
/*
...
#define lwsl_info(...) logprintf(LLL_INFO, __VA_ARGS__)
#define lwsl_debug(...) logprintf(LLL_DEBUG, __VA_ARGS__)
#define lwsl_parser(...) logprintf(LLL_PARSER, __VA_ARGS__)
#define lwsl_header(...)  logprintf(LLL_HEADER, __VA_ARGS__)
#define lwsl_ext(...)  logprintf(LLL_EXT, __VA_ARGS__)
#define lwsl_client(...) logprintf(LLL_CLIENT, __VA_ARGS__)
#define lwsl_latency(...) logprintf(LLL_LATENCY, __VA_ARGS__)
