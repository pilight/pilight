...
static void parseCode(void) {
    int i = 0, c=0, s=0, x = 0, binary[MAX_RAW_LENGTH/2], start=0;
    int id = 0, battery = 0, channel = 0, m=0;
	int msg[MESSAGE_LENGTH], syncIndex1;
	...
	*/
    for(unsigned int x=0; x<bre->rawlen; x++) {
