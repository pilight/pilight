...
void iwds07Init(void) {
	...
	protocol_set_id(iwds07, "GW-iwds07");
	protocol_device_add(iwds07, "GW-iwds07", "GW-iwds07 contacts");
	...
	options_add(&iwds07->options, 'b', "battery", OPTION_NO_VALUE, DEVICES_STATE, JSON_NUMBER, NULL, NULL);
	options_add(&iwds07->options, 't', "opened", OPTION_NO_VALUE, DEVICES_STATE, JSON_NUMBER, NULL, NULL);
	options_add(&iwds07->options, 'f', "closed", OPTION_NO_VALUE, DEVICES_STATE, JSON_NUMBER, NULL, NULL);
