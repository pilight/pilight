...
static void parseCode(void) {
	...
	xiron->message = json_mkobject();
	json_append_member(xiron->message, "id", json_mknumber(id, 0));
	json_append_member(xiron->message, "temperature", json_mknumber(temperature, 1));
	json_append_member(xiron->message, "humidity", json_mknumber(humidity, 1));
	json_append_member(xiron->message, "battery", json_mknumber(battery, 0));
	json_append_member(xiron->message, "channel", json_mknumber(channel, 0));
}
