...
// Timing from this attachment: https://forum.pilight.org/attachment.php?aid=1058
// of this post: https://forum.pilight.org/showthread.php?tid=1435&pid=25180#pid25180
...
// TODO: minimize NORMAL_REPEATS while being reliable: execute tests
...
static void parseCode(void) {
	int binary[BINARY_LENGTH], x = 0, id = 0;
	...
	id = binToDec(binary, 0, BINARY_LENGTH - 1);
	createMessage(id);
}
