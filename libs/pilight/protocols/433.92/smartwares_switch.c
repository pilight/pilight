...
void smartwaresSwitchInit(void) {
	...
	protocol_device_add(smartwares_switch, "kaku_switch", "KlikAanKlikUit Switches");
	protocol_device_add(smartwares_switch, "dio_switch", "D-IO Switches");
	protocol_device_add(smartwares_switch, "nexa_switch", "Nexa Switches");
	protocol_device_add(smartwares_switch, "coco_switch", "CoCo Technologies Switches");
	protocol_device_add(smartwares_switch, "intertechno_switch", "Intertechno Switches");
