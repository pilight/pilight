...
dpkg -X pilight-8.1.3-Linux-pilight.deb source
dpkg -e pilight-8.1.3-Linux-pilight.deb control
...
dpkg -X pilight-8.1.3-Linux-webgui.deb source
dpkg -e pilight-8.1.3-Linux-webgui.deb control
