...
dpkg -X pilight-8.0.7-Linux-pilight.deb source
dpkg -e pilight-8.0.7-Linux-pilight.deb control
...
dpkg -X pilight-8.0.7-Linux-webgui.deb source
dpkg -e pilight-8.0.7-Linux-webgui.deb control
