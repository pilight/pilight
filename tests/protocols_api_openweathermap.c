		...
		case MIDNIGHT:
			switch(steps) {
				case 0: {
					 ...
					 */
					steps = 1;
					CuAssertIntEquals(gtc, 3, duration);
				} break;
				case 1: {
					CuAssertIntEquals(gtc, 0, duration);
					/*
...
static void test_protocols_api_openweathermap_midnight(CuTest *tc) {
	...
	strcpy(add, "{\"test\":{\"protocol\":[\"openweathermap\"],\"id\":[{\"country\":\"nl\",\"location\":\"amsterdam\"}],\"humidity\":94.00,\"temperature\":0.21,\"sunrise\":8.29,\"sunset\":17.05,\"sun\":\"set\",\"update\":0,\"poll-interval\":3}}");
